...
- [ ] Add more ABR algorithms (BOLA, MPC, Pensieve)
- [ ] Implement video codec simulation (H.264, H.265, VP9)
...
- Inspired by real-world streaming platforms (Netflix, YouTube, Twitch)
- ABR algorithm concepts from academic research papers
- Network simulation techniques from computer networking courses
...
- Academic papers on adaptive bitrate algorithms
